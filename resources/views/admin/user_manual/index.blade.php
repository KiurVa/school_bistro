    ...
    <div class="card">
        ...
        <div class="card-body">
            <p class="text-muted mb-4">
                Käesolev juhend annab praktilise ülevaate School Bistro haldusliidese peamistest vaadetest ja nende kasutamisest.
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show"
                        ...
                        <div class="accordion-body">
                            <p>
                                ...
                                menüüdes kuvatavaid toite, kategooriaid, allergeene, taustapilte ning kasutajate ligipääsu.
                            </p>
                            <p class="mb-0">
                                Haldusliides on mõeldud kasutamiseks administraatorile või töötajale, kes vastutab menüüde
                                koostamise, andmete ajakohastamise ja süsteemi korrashoiu eest. Enamik toiminguid toimub
                                eraldi halduslehtedel, kus saab andmeid lisada, muuta, kustutada ja järjestada.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="collapseTwo"
                        ...
                        <div class="accordion-body">
                            <ol>
                                ...
                                <li>Sisesta oma kasutajanimi või e-posti aadress ning parool.</li>
                            ...
                            <p class="mb-0">
                                Kui sisselogimine ei õnnestu, kontrolli sisestatud andmeid, klaviatuuri keelevalikut
                                ning veendu, et parool oleks õigesti sisestatud.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="collapseThree"
                        ...
                        <div class="accordion-body">
                            ...
                            <p>
                                ...
                                Sellelt lehelt saab menüüsid lisada, aktiveerida, vaadata, muuta, kopeerida ja kustutada.
                            </p>
                            ...
                            <ul>
                                ...
                                <li>
                                    <strong>Lisa toidud</strong> – võimaldab lisada või muuta mitu toitu korraga ühel lehel.
                                </li>
                                <li>
                                ...
                                <li>
                                    <strong>Muuda</strong> – võimaldab muuta menüü kuupäeva, menüü tüüpi ja päises kuvatavaid tekstiridu.
                                </li>
                                <li>
                    ...
                    <div id="collapseEight"
                        ...
                        <div class="accordion-body">
                            ...
                            <p class="mb-0">
                                ...
                                Turvalisuse huvides ei saa sisseloginud kasutaja iseennast kustutada.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseNine"
                        ...
                        <div class="accordion-body">
                            ...
                            <h6 class="fw-semibold mt-3">Kokkuvõtte plokid</h6>
                            <ul>
                            ...
                            <p>
                                ...
                                Tulemusi saab filtreerida menüütüübi ja kategooria järgi, et saada täpsem ülevaade.
                            </p>
